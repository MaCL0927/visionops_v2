...
def main() -> None:
    ...
    checkpoint_path = Path(export_cfg.get("checkpoint_path", "models/checkpoints_segmentation/best.pt"))
    output_path = Path(export_cfg.get("output_path", "models/export_segmentation/model.onnx"))
    ...
    save_json(result, Path("models/export_segmentation/export_result.json"))

...
models/export/rknn_report.json
...
def main() -> None:
    ...
    metrics_dir = Path(mlops_cfg.get("paths", {}).get("metrics_dir", "models/metrics_classification"))
    export_dir = Path(mlops_cfg.get("paths", {}).get("export_dir", "models/export_classification"))
    ...
    rknn_report_path = export_dir / "rknn_report.json"

...
def maybe_reexec_in_rknn_env(cfg: dict) -> None:
    ...
    cmd = [str(python_path), "-m", "pipeline.tasks.classification.convert_rknn", *sys.argv[1:]]
...
def simulate_conversion(cfg: dict) -> dict:
    ...
    report = {
        ...
        "onnx_path": output_cfg.get("onnx_model", "models/export_classification/model.onnx"),
